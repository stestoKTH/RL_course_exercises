...
def td_lambda(env, policy, lambd=0.9, alpha=0.1, gamma=0.9, num_episodes=1, epsilon=0.0):
    ...
    for episode in range(num_episodes):
        ...
        while not (done or terminated):
            ...
            td_error = reward + gamma * (1-done) * V[next_state] - V[state]    # TODO
            E[state] += 1                                                      # TODO: Increment eligibility trace for the current state

            # Update value function and eligibility traces for all states
            V += alpha * td_error * E                                          # TODO: Update state value with TD error and trace
            E *= gamma * lambd                                                 # TODO: Apply decay to eligibility traces
